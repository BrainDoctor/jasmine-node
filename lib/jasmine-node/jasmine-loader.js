(function () {
    ...
    var executeSpecsInFolder = function (options) {
        ...
        var specsList = fileFinder.find(options.specFolders, options.regExpSpec);
        if (options.junit) {
            if (options.reporterConfigOpts == null) {
                options.reporterConfigOpts = {};
            }
            var junit = new jasmineEnv.JUnitXmlReporter(options.reporterConfigOpts);
        ...
        if (options.nunit) {
            ...
            var nunit = new jasmineEnv.NUnitXmlReporter(options.reporterConfigOpts);
        ...
        var _i = 0;
        var _len = specsList.length;
        for (_i, _len; _i < _len; _i++) {
            var spec = specsList[_i];
